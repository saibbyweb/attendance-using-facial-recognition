    ...
    <AppBar position="fixed">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <img src="https://www.kashmiruniversity.net/images/KUGreen.png" style={{ boxSizing: 'border-box', height: '7vh', backgroundColor: 'white', borderRadius: '2px', marginRight: '5px', padding: '6px 10px'}} />
          {/* <Typography
            variant="h6"
            noWrap
            component="a"
